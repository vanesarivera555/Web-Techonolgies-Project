...
function refresh_div() {  //create a new function called refresh_div, this function will cald ajax query method for jquery.
    $.ajax({
        type: 'post',
        url: 'https://ec2-18-118-187-45.us-east-2.compute.amazonaws.com/hw16/query_entries.php',  //for querying info, go here and get all data returned, and to be sent to content. Body div will be recieave this information.
